...
public final class StringPart extends BasePart {
     ...
     * @param mimeType String, if null is passed then default "text/plain" mime type is used.
     ...
     */
    public StringPart(String name, String value, String mimeType, String charset) {
        if (name == null) {
        ...
        final String partMimeType = mimeType;
        ...
        headersProvider = new IHeadersProvider() {
            ...
            public String getContentType() {
                return "Content-Type: " + partMimeType + HTTP.CHARSET_PARAM + partCharset;          //$NON-NLS-1$
            }
